...
\begin{document}
	...
	are now cheap to access individually: (1) managed Backend-as-a-Service for data and auth,
	(2) serverless compute that scales to zero, and (3) on-demand large-language-model and
	embedding APIs. Assembled correctly, these let a single developer ship a differentiated,
