...
- **Trạng thái migration thực tế:** đã chạy tới `00008` (backfill profile). **`00009`, `00010`, `00011`, `00012` CẦN được chạy** trong Supabase SQL Editor (`00009` FK + hardening; `00010` `completed_at`; `00011` trigger đồng bộ email; `00012` RPC `change_my_email` để đổi email không cần confirm). Sau `00009`: `sync_log` bị drop.
